...
4. [Understanding the Critical Rendering Path](https://bitsofco.de/understanding-the-critical-rendering-path/)
5. **How JavaScript works** by _Alexander Zlatkov_ ([in russian](https://habr.com/ru/company/ruvds/blog/419831/))
...
8. [The modern guide to React state patterns](https://blog.logrocket.com/modern-guide-react-state-patterns/)
9. State management
